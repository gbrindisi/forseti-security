...
"""Rules engine for Cloud Buckets.

1. Build the RuleBook (BucketsRuleBook) from the rule definitions (file either
   stored locally or in GCS).
2. Get the GCP buckets data.
3. Compare the GCP buckets data against the RuleBook to determine whether there
   are violations.
"""
...
class BucketsRulesEngine(bre.BaseRulesEngine):
    """Rules engine for buckets-related resources."""
...
class BucketsRuleBook(bre.BaseRuleBook):
    """The RuleBook for buckets resources."""
