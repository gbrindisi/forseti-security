...
# TODO: everything, this is started as a copy of IamPolicy
...
def _get_iam_members(members):
    """Get a list of this binding's members as BucketMembers.

    Args:
        members: A list of members (strings).

    Returns:
        A list of BucketMembers.
    """
    return [BucketMember.create_from(m) for m in members]
...
class Bucket(object):
    ...
    def __eq__(self, other):
        """Tests equality of Bucket."""
        if not isinstance(other, type(self)):
            return NotImplemented
        return self.bindings == other.bindings

    def __ne__(self, other):
        """Tests inequality of Bucket."""
        return not self == other

    def __repr__(self):
        """String representation of Bucket."""
        return 'Bucket: <bindings={}>'.format(self.bindings)
...
class BucketBinding(object):
    ...
    def __init__(self, role_name, members=None):
        ...
        if not role_name or not members:
            raise errors.InvalidBucketBindingError(
                ('Invalid Bucket binding: '
    ...
    def __eq__(self, other):
        """Tests equality of BucketBinding."""
        if not isinstance(other, type(self)):
            return NotImplemented
    ...
    def __ne__(self, other):
        """Tests inequality of BucketBinding."""
        return not self == other

    def __repr__(self):
        """String representation of BucketBinding."""
        return 'IamBinding: <role={}, members={}>'.format(
            self.role_name, self.members)

    @classmethod
    def create_from(cls, binding):
        """Create an BucketBinding from a binding dict.

        Args:
            binding: The dict binding (role mapped to members).

        Returns:
            A new BucketBinding created with the role and members.
        """
...
class BucketMember(object):
    ...
    def __init__(self, member_type, member_name=None):
        ...
        if not member_type or not self._member_type_exists(member_type):
            raise errors.InvalidBucketMemberError(
    ...
    def __eq__(self, other):
        """Tests equality of BucketMember."""
        if not isinstance(other, type(self)):
            return NotImplemented
    ...
    def __ne__(self, other):
        """Tests inequality of BucketMember."""
        return not self == other

    def __hash__(self):
        """Hash function for BucketMember."""
        return hash((self.type, self.name))

    def __repr__(self):
        """String representation of BucketMember."""
    ...
    def create_from(cls, member):
        """Create an BucketMember from the member identity string."""
    ...
    def matches(self, other):
        ...
        if isinstance(other, type(self)):
            ...
            other_member = BucketMember.create_from(other)
